...
google_sheets:
  spreadsheet_id: 1lIZRyQ7WhEU3HZl2b1YAmAMgJNESz2IQq74zba218RQ  # 실제 ID 노출
  service_account_path: /Users/user/.config/google_sheet/service_account_key.json  # 경로 노출
```
...
git log -p --all -S '1lIZRyQ7WhEU3HZl2b1YAmAMgJNESz2IQq74zba218RQ'
# 결과가 없어야 함
